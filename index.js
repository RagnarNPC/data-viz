...
// RapidAPI code to retrieve trending twitter topics.
...
const options = {
	method: 'POST',
	headers: {
		'x-rapidapi-key': 'a7d2579c22msh29697de25123a6ep19a835jsn3c72052082e1',
		'x-rapidapi-host': 'twitter-trends5.p.rapidapi.com'}, body: data
};
